...
<head>
<meta charset="UTF-8">
<title>UPDATE COMPANY FORM</title>
...
<div class="card-form">
    ...
    <div class="form-section">
        <form action="UpdateCompanyServe" method="post">
            <h2>UPDATE COMPANY FORM</h2>
            <input type="number" class="form-control" name="compid" placeholder="Enter Company Id" required/>
    ...
    <div class="image-section">
        <img src="https://cdn-icons-png.flaticon.com/512/2991/2991110.png" alt="Company Illustration"/>
    </div>
</div>
